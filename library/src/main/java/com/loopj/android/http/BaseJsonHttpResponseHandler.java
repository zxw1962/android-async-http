 ...
 */
public abstract class BaseJsonHttpResponseHandler<JSON_TYPE> extends AsyncGenericResponseHandler<JSON_TYPE> {
     ...
     */
    @Override
    public abstract void onSuccess(int statusCode, Header[] headers, JSON_TYPE response);
     ...
     */
    @Override
    public abstract void onFailure(int statusCode, Header[] headers, JSON_TYPE response, Throwable throwable);
}
