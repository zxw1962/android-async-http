...
public abstract class AsyncGenericResponseHandler<T> implements ResponseHandlerInterface<T> {
     ...
     */
    public AsyncGenericResponseHandler() {
        this(null);
    }
     ...
     */
    public AsyncGenericResponseHandler(Looper looper) {
     ...
     */
    public abstract void onSuccess(int statusCode, Header[] headers, T responseBody);
     ...
     */
    public abstract void onFailure(int statusCode, Header[] headers, T responseBody, Throwable error);
    ...
    @Override
    final public void sendSuccessMessage(int statusCode, Header[] headers, T responseBody) {
